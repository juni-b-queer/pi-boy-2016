...
class Module(pypboy.SubModule):
	...
	def handle_resume(self):
		...
		self.parent.pypboy.header.title = " HP 200/200  |  AP 62/62"
...
class Health(game.Entity):
	...
	def __init__(self):
		...
		text = config.FONTS[18].render("Bender - Level 27", True, (105, 251, 187), (0, 0, 0))
		text_width = text.get_size()[0]
		self.image.blit(text, (config.WIDTH / 2 - 8 - text_width / 2, 230))
