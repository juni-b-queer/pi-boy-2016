...
class RadioNewVegas(RadioStation):

	def __init__(self, *args, **kwargs):
		self.directory = 'sounds/radio/rnv/'
		super(RadioNewVegas, self).__init__(self, *args, **kwargs)
...
class PopRadio(RadioStation):

	def __init__(self, *args, **kwargs):
		self.directory = 'sounds/radio/pop/'
		super(PopRadio, self).__init__(self, *args, **kwargs)
